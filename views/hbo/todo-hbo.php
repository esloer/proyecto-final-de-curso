...
<head>
    ...
    <script src="/assets/js/hbo/todo-hbo.js" defer></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus" class="bus" type="text"
                    placeholder="Busca una serie o película en HBO" />
                <form method="GET" action="/todoHBO">
    ...
    <main>
        ...
        <?php else: ?>
        <h1>Series y peliculas disponibles en HBO</h1>
        <?php endif; ?>

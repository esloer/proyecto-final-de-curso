...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-series" class="bus" type="text"
                    placeholder="Busca una serie  en HBO" />
                <form method="GET" action="/seriesHbo">
    ...
    <main>
        ...
        <h1>Series de tipo <?php echo ucfirst($genero); ?> en HBO</h1>
        <?php else: ?>
        <h1>Series disponibles en HBO</h1>
        <?php endif; ?>

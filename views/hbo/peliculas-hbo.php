...
<head>
    ...
    <title>All Peliculas HBO</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/hbo/peliculas-hbo.js"></script>
...
<body>
    <header>
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-peliculas" class="bus" type="text" placeholder="Busca una película en HBO" />
                <form method="GET" action="/peliculasHbo">
    ...
    <main>
        ...
        <h1>Películas de tipo <?php echo ucfirst($genero); ?> en HBO</h1>
        <?php else: ?>
        <h1>Películas disponibles en HBO</h1>
        <?php endif; ?>

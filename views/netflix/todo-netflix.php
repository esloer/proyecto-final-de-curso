...
<head>
    ...
    <title> All Netflix</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/netflix/todo-netflix.js" defer></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus" class="bus" type="text"
                    placeholder="Busca una serie o película en Netflix" />
                <form method="GET" action="/todoNetflix">
    ...
    <main>
        ...
        <?php else: ?>
        <h1>Series y peliculas disponibles en Netflix</h1>
        <?php endif; ?>

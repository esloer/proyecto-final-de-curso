...
<head>
    ...
    <title>All Peliculas Netflix</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/netflix/peliculas-netflix.js"></script>
...
<header>
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-peliculas" class="bus" type="text"
                    placeholder="Busca una película en Netflix" />
                <form method="GET" action="/peliculasNetflix-genero">
    ...
    <main>
        ...
        <h1>Películas del tipo <?php echo ucfirst($genero); ?> en Netflix</h1>
        <?php else: ?>
        <h1>Películas disponible en Netflix</h1>
        <?php endif; ?>

...
<head>
    ...
    <title>All Prime Video Series</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/prime/series-prime.js"></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-series" class="bus" type="text"
                    placeholder="Busca una serie en Prime video" />
                <form method="GET" action="/SeriesPrime-Generos">
    ...
    <main>
        ...
        <h1>Series de tipo <?php echo ucfirst($genero); ?> en Prime video</h1>
        <?php else: ?>
        <h1>Series disponibles en Prime Video</h1>
        <?php endif; ?>

...
<head>
    ...
    <title>All Prime Video</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/prime/todo-prime.js" defer></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus" class="bus" type="text"
                    placeholder="Busca una serie o película en Prime video" />
                <form method="GET" action="/todoPrime">
    ...
    <main>
        ...
        <?php else: ?>
        <h1>Series y peliculas disponibles en Prime video</h1>
        <?php endif; ?>

...
<head>
    ...
    <title>All Peliculas Prime Video</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/prime/peliculas-prime.js"></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-peliculas" class="bus" type="text"
                    placeholder="Busca una película en Prime video" />
                <form method="GET" action="/peliculasPrime-genero">
    ...
    <main>
        ...
        <h1>Películas de tipo <?php echo ucfirst($genero); ?> en Prime video</h1>
        <?php else: ?>
        <h1>Películas disponibles en Prime Video</h1>
        <?php endif; ?>

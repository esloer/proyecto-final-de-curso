...
<body>
    <header>
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus" class="bus" type="text"
                    placeholder="Busca una serie o película en todas las plataformas" />
        ...
        <div class="link-logos ">
            <a href="/todoNetflix"><img src="../assets/img/netflix/logos/netflix-link.jpg" alt="hbo" /></a>
            <a href="/todoHBO"><img src="../assets/img/hbo/logos/hbo-link.jpg" alt="hbo" /></a>
            <a href="/todoPrime"><img src="../assets/img/prime/logos/prime-link.jpg" alt="prime" /></a>
            <a href="/todoDisney"><img src="../assets/img/disney/logos/disney.jpg" alt="disney" /></a>
        </div>
    </header>
    <main>
        <?php if ($genero && $genero !== 'todo'): ?>
        <h1> Series y películas de tipo <?php echo ucfirst($genero); ?></h1>
        <?php else: ?>
        <h1>Series y peliculas disponibles en todas las plataformas</h1>
        <?php endif; ?>
        ...
        <div id="video-container">
            ...
            <iframe id="video-player" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </main>
    <footer></footer>
</body>

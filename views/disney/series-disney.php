...
<head>
    ...
    <title>All Disney Plus Series</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/disney/series-disney.js"></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-series" class="bus" type="text"
                    placeholder="Busca una serie en Disney plus" />
                <form method="GET" action="/SeriesDisney-Generos">
    ...
    <main>
        ...
        <h1>Series de tipo <?php echo ucfirst($genero); ?> en Disney plus</h1>
        <?php else: ?>
        <h1>Series disponibles en Disney plus</h1>
        <?php endif; ?>

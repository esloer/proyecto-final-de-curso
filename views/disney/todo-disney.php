...
<head>
    ...
    <title>All Disney plus</title>
    <link rel="icon" href="../assets/img/interno/pestaña.jpg" type="image/x-icon">
    <link rel="stylesheet" href="/assets/css/style.css">
    <script src="/assets/js/disney/todo-disney.js" defer></script>
...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus" class="bus" type="text"
                    placeholder="Busca una serie o película en Disney plus" />
                <form method="GET" action="/todoDisney">
    ...
    <main>
        ...
        <?php else: ?>
        <h1>Series y peliculas disponibles en Disney plus</h1>
        <?php endif; ?>

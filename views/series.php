...
<header>
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-series" class="bus" type="text"
                    placeholder="Busca una serie en todas las plataformas" />
                <form method="GET" action="/series-generos">
    ...
    <main>
        ...
        <h1>Series de tipo <?php echo ucfirst($genero); ?></h1>
        <?php else: ?>
        <h1>Series disponibles en todas las plataformas</h1>
        <?php endif; ?>

...
<body>
        ...
        <div class="links-tipos">
            ...
            <div class="bus-sel">
                <input id="bus-peliculas" class="bus" type="text"
                    placeholder="Busca una película en todas las plataformas" />
                <form method="GET" action="/peliculas-genero">
    ...
    <main>
        ...
        <h1>Películas de tipo <?php echo ucfirst($genero); ?></h1>
        <?php else: ?>
        <h1>Películas disponibles en todas las plataformas</h1>
        <?php endif; ?>
